...
# setwd(xlsx_path)
# if (save){
#   write.csv(NPY_Cre_X_iSPN_6OHDA_fits, file = 'NPY_Cre_X_iSPN_6OHDA_fits.csv', row.names = FALSE)
#   write.csv(NPY_Cre_X_iSPN_6OHDA_peaks, file = 'NPY_Cre_X_iSPN_6OHDA_peaks.csv', row.names = FALSE)
#   }
