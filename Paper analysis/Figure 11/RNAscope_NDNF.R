...
required.packages <- c('bayesplot', 'brms', 'dbscan', 'lme4', 'robustbase', 'minpack.lm', 'parallel', 'Rcpp', 'robustlmm', 'sciplot', 'signal')
...
RNAscope_data[1:10,]
#    condition cell_type slice_id              field hemisphere field_index replicate count session session_group
# 1     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.01         UL           1         1    22  L1.ST8        L1.ST8
# 2     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.01         UL           1         2    25  L1.ST8        L1.ST8
# 3     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.01         UL           1         3    13  L1.ST8        L1.ST8
# 4     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.01         UL           1         4     7  L1.ST8        L1.ST8
# 5     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.01         UL           1         5    14  L1.ST8        L1.ST8
# 6     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.02         UL           2         1    16  L1.ST8        L1.ST8
# 7     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.02         UL           2         2    11  L1.ST8        L1.ST8
# 8     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.03         UL           3         1    33  L1.ST8        L1.ST8
# 9     Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.03         UL           3         2    22  L1.ST8        L1.ST8
# 10    Intact     NDNF+ L1.ST8_C L1.ST8_C.UL_60x.03         UL           3         3    21  L1.ST8        L1.ST8
...
#  field    (Intercept) 28.10    5.301   
#  Residual             41.12    6.412   
# Number of obs: 167, groups:  field, 54
...
# Scaled residuals: 
#      Min       1Q   Median       3Q      Max 
# -2.44614 -0.63142 -0.02651  0.82973  2.99554 

# Random effects:
#  Groups   Name        Variance Std.Dev.
#  field    (Intercept)  0.2543  0.5043  
#  Residual             10.4167  3.2275  
# Number of obs: 87, groups:  field, 50

# Fixed effects:
#             Estimate Std. Error      df t value Pr(>|t|)    
# (Intercept)   7.0702     0.3552 36.4945  19.906  < 2e-16 ***
# Group1        1.0175     0.3552 36.4945   2.865  0.00688 ** 
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
if (plotsave) save_graph(svg_path=svg_path, filename='RNAscope_boxplot_NDNF.svg', width=width, height=height, bg='transparent')
...
# if (plotsave) save_graph(svg_path=svg_path, filename='pseudoreplication_NDNF.svg', width=width, height=height, bg='transparent')
...
legend('topright',
       ...
       bty='n', box.lwd=0, cex=0.85)
if (plotsave) save_graph(svg_path=svg_path, filename='Bayesian_Analysis_NDNF.svg', width=width, height=height, bg='transparent')
