...
conda_packages <- jsonlite::fromJSON(paste(system2(reticulate:::conda_binary(), c('list', '-n', env_name, '--json'), stdout = TRUE), collapse = '\n'))
installed_packages <- conda_packages$name
